...
{
  case "$1" in
  "ReadyRemitSDK.xcframework/ios-arm64")
    echo ""
    ;;
  "ReadyRemitSDK.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "VisaSensoryBranding.xcframework/ios-arm64")
    echo ""
    ;;
  "VisaSensoryBranding.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
